...
public class RightClickOptions
{
	...
	*/
    ...
    public static final HashMap<Integer, Integer> interactTargets = new HashMap<Integer, Integer>();
    ...
    public void preInit(FMLPreInitializationEvent preInitEvent)
    {
    	...
    	wrapper.registerMessage(ClientTradeUpdateResponsePacket.Handler.class, ClientTradeUpdateResponsePacket.class, 2, Side.SERVER);
    	wrapper.registerMessage(ClientTradeUpdatePacket.Handler.class, ClientTradeUpdatePacket.class, 3, Side.CLIENT);
		wrapper.registerMessage(InteractServerResponsePacket.Handler.class, InteractServerResponsePacket.class, 4, Side.CLIENT);
